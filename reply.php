...
// 編集する文章をデータベースから取り出し
$edit = new Edit($_REQUEST);
list($edit,$message) = $edit->editData();
  ...
  <!-- コンテンツフォーム -->
    <div class="board_form">
      <form action="" method="post">
        ...
        <div>
          <p>本文</p>
          <textarea class="form_textarea" name="本文" rows="4" cols="50" maxlength="64" placeholder=""><?php echo($message)?></textarea>
          <?php if($empty[1] == 1): ?>
            <p class="empty">入力してください</p>
          <?php endif;?>
        </div>
